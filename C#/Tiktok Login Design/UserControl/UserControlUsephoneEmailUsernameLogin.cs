...
{
    public partial class UserControlUsephoneEmailUsernameLogin
    {
        public UserControlUsephoneEmailUsernameLogin()
        {
            InitializeComponent();
        }
        ...
        {
            My.MyProject.Forms.Form1.Guna2Panel1.Controls.Clear();
            My.MyProject.Forms.Form1.Guna2Panel1.Controls.Add(new LogInWithPassword());
        }
    }
}